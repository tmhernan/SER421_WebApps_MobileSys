/*
Activity 2: Implement a “forum” ON THE CLIENT 
...
You will use a dictionary structure provided to you. 
...
function getNameCookie() {
    var review =
        'Review <br> Unabashedly whimsical childishness carried off with such intoxicating upbeat energy that its pure bliss to watch it with or without a child in tow.';
    console.log('hello');
